            ...
            <div className="card h-full">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a href=" https://testflight.apple.com/join/JwJEGyUP" className="btn btn-outline flex-1 justify-center">
                    iOS
                  </a>
                  <a href="https://storage.googleapis.com/juno_media/constants/juno_0.9.0.apk" className="btn btn-outline flex-1 justify-center">
                    Android
                  </a>
                </div>
              </div>
